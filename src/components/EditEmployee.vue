    ...
    <v-sheet>
     ...
     <v-container fluid>
        <form class="pa-2">
            ...
            <v-row >
                <v-col cols="5">
                    <div class="title mb-1">Your image</div>
                    <v-img height="100" width="100" src="https://picsum.photos/510/300?random" ></v-img>
                </v-col>
            </v-row>
            <v-checkbox
            v-model="checkbox"
  ...
  export default {
    ...
    computed: {
      ...
      phoneErrors () {
        ...
        !this.$v.phone.minLength && errors.push('Phone must be at most 10 characters long')
